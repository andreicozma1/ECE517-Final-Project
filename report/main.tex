...
\twocolumn[
    \icmltitle{GPT2PPO: A blah blah blah}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NOTE - Moved the abstract to introduction bc we dont really need one

%\begin{abstract}
%    In this project, we explore the use of two popular Reinforcement Learning
%    algorithms, Q-learning and SARSA, to play the game of Pong.
%    We compare the performance of these algorithms and analyze their behavior
%    in different learning scenarios through a series of experiments.
%    We also discuss the effect of hyperparameters on the performance of the algorithms.
%    Finally, we analyze the results and discuss the performance of the algorithms
%    through a variety of metrics collected during the experiments.
%\end{abstract}
