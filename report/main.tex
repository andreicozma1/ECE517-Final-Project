...
In this work we only use the discrete version. The state space is a 8-dimensional vector containing the position and velocity of the rocket, the angle and angular velocity of the rocket, and the position of the landing pad.

\begin{figure}[htbp]
    \centerline{\includegraphics{./img/lunar-lander-env.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics{./img/acrobot-env.png}}
...
% \begin{figure}[htbp]
%     \centerline{\includegraphics{/img/bipedal-walker-env.png}}
